    ...
    <div className="h-screen w-full flex items-center justify-center font-ibmplex">
      <div className="grid h-full w-full grid-cols-10 grid-rows-8 gap-5 p-10">
        ...
        xl:col-span-8 xl:row-span-1 grids-cols-4 grid-rows-3 gap-4">
            ...
            <p className="transition ease-in-out delay-50 hover:scale-105 text-4xl xl:text-5xl cursor-pointer opacity-70 hover:opacity-100" onClick={() => redirect('/skill/coding')}>Coding</p>
              ...
              <p className="transition ease-in-out delay-50 hover:scale-110 text-5xl xl:text-5xl scale-125 cursor-pointer opacity-100 hover:opacity-100" onClick={() => redirect('/skill/experience')}>Work Experience</p>
            </div>
          </div>
          <div className="transition ease-in-out delay-50 opacity-90 hover:opacity-100 h-full w-full 
        xl:col-span-8 xl:row-span-7 grids-cols-4 grid-rows-3 border-2 border-4 rounded-md shadow-md ">
            <div className="flex flex-wrap place-content-center text-center p-10">
              ...
              <ol class="relative border-s border-gray-200 dark:border-gray-700">                  
                  <li class="mb-10 ms-4">
                      ...
                      <h3 class="text-lg font-semibold text-gray-900 text-white">Freelance Video Editor for Mudan Media Group</h3>
...
GeeXplus, Connordawg, Premiertwo, etc. </p>
                  ...
                  <li class="mb-10 ms-4">
                      ...
                      <h3 class="text-lg font-semibold text-gray-900 text-white">Freelance Video Editor on Fiverr</h3>
                      <p class="text-base font-normal text-gray-500 text-gray-400">Operates and manage post production services on Fiverr with over 54 jobs(Video and thumbnail projects) completed.
